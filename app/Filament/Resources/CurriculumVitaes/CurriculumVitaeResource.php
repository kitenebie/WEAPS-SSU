...
class CurriculumVitaeResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Alumni List';
    protected static ?string $recordTitleAttribute = 'Alumni List';
    protected static ?string $navigationLabel = 'Alumni List';
    protected static ?string $slug = 'Alumni List';
