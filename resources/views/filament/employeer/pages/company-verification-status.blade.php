...
<body class="bg-slate-50">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <button onclick="history.back()"
                        class="inline-flex items-center px-4 py-2 bg-red-700 hover:bg-red-900 text-gray-50 font-medium rounded-lg transition-colors duration-200">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold text-white">Company Verification Status</h1>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden md:flex items-center space-x-2 text-sm bg-red-50 px-3 py-1 rounded-full">
                        ...
                        <span class="text-red-700 font-medium">Verified</span>
                    </div>
                    <div class="hidden md:flex items-center space-x-2 text-sm bg-red-50 px-3 py-1 rounded-full">
                        ...
                        <span class="text-red-700 font-medium">Active Company</span>
                    </div>
                    <?php else: ?>
                    <div class="hidden md:flex items-center space-x-2 text-sm bg-red-50 px-3 py-1 rounded-full">
                    ...
                    <div class="hidden md:flex items-center space-x-2 text-sm bg-red-50 px-3 py-1 rounded-full">
                        ...
                        <span class="text-red-700 font-medium">Admin Review</span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="container-full mx-auto px-4 py-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-12">
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r <?= $isCompanyActive ? 'from-red-800 to-red-900' : 'from-red-800 to-red-900' ?> rounded-full mb-6 shadow-lg">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-slate-200/60 p-8 mb-8">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="text-right">
                            <div class="text-3xl font-bold <?= $isCompanyActive ? 'text-red-600' : 'text-red-600' ?> mb-1"
                                id="overall-progress">
                    ...
                    <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden mb-8">
                        <div class="bg-gradient-to-r <?= $isCompanyActive ? 'from-red-800 to-red-900' : 'from-red-800 to-red-900' ?> h-4 rounded-full transition-all duration-1000 ease-out"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="text-center" id="step-2">
                            ...
                            <div class="mt-2">
                                <div class="text-xs text-red-600 animate-pulse">Admin reviewing documents...</div>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-8">
                        <button onclick="MyAccount()"
                            class="inline-flex items-center px-6 py-3 <?= $isCompanyActive ? 'bg-red-800 hover:bg-red-900' : 'bg-slate-400 cursor-not-allowed' ?> text-white font-semibold rounded-lg transition-colors duration-200">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-slate-200/60 p-8 mb-8">
                    ...
                    <div class="bg-red-50 border-l-4 border-red-400 p-6 mb-6">
                        <div class="flex">
                            ...
                            <div>
                                <h3 class="text-red-900 font-semibold mb-1">Company Verified Successfully!</h3>
                    ...
                    <div class="bg-red-50 border-l-4 border-red-400 p-6 mb-6">
                        <div class="flex">
                            ...
                            <div>
                                <h3 class="text-red-900 font-semibold mb-1">Admin Review in Progress</h3>
                                <p class="text-red-800 text-sm leading-relaxed">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-slate-200/60 p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            <div
                                class="inline-flex items-center justify-center w-8 h-8 bg-red-50 text-red-600 font-bold rounded-full mr-4 flex-shrink-0 animate-pulse">
                                1</div>
                            <div>
    ...
    <script>
        ...
        function MyAccount() {
            ...
            setTimeout(() => {
                location.href = '/employeer/company-verification-status/completed';
            }, 1500);
            <?php else: ?>
