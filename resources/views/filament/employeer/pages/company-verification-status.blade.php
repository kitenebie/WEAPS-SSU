...
<body class="bg-slate-50">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-12">
                    ...
                    <p class="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                        Your company registration is being verified by our AI system. This process typically takes 2-5 minutes.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-slate-200/60 p-8 mb-8">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="text-right">
                            <div class="text-3xl font-bold text-rose-600 mb-1" id="overall-progress">0%</div>
                    ...
                    <div class="w-full bg-slate-200 rounded-full h-4 overflow-hidden mb-8">
                        <div class="bg-gradient-to-r from-rose-500 to-pink-600 h-4 rounded-full transition-all duration-1000 ease-out" id="overall-progress-bar" style="width: 0%"></div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="text-center" id="step-2">
                            ...
                            <div class="mt-2">
                                <div class="text-xs text-blue-600 animate-pulse">Processing documents...</div>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-blue-800 text-sm leading-relaxed">
                                    Our AI system is currently analyzing your company documents, business permits, and registration information.
                                    This automated process checks for authenticity, completeness, and compliance with our verification standards.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                            ...
                            <p class="text-sm text-amber-800 ml-7">
                                AI verification typically takes <strong>2-5 minutes</strong>.
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm">Our AI system will finish analyzing your documents and provide an initial verification result.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm">Once approved, you'll receive email confirmation and can begin posting job opportunities on our platform.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateProgress() {
            ...
            if (currentProgress >= 75 && verificationStage === 'ai_processing') {
