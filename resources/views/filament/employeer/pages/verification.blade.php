        ...
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-slate-600 max-w-2xl mx-auto">
                    Select whether you want to register as a company looking to hire talent or as an applicant seeking opportunities.
                </p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <!-- Company Registration Card -->
                <div class="bg-white rounded-xl shadow-lg border border-slate-200 p-8 hover:shadow-xl transition-all duration-300 hover:border-rose-300 hover:border-l-4 hover:border-l-rose-500">
                    <div class="text-center">
                        ...
                        <p class="text-slate-600 mb-8 leading-relaxed">
                            Create a company profile to post job opportunities, manage applications, and connect with talented professionals in your industry.
                        </p>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-slate-200 p-8 hover:shadow-xl transition-all duration-300 hover:border-emerald-300 hover:border-l-4 hover:border-l-emerald-500">
                    <div class="text-center">
                        <!-- Applicant Icon -->
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 mb-4">Register as Applicant</h3>
                        <p class="text-slate-600 mb-8 leading-relaxed">
                            Create your professional profile to showcase your skills, experience, and find exciting career opportunities that match your expertise.
                        </p>
